		...
		<div class="row" id="productMain">
            ...
            <div class="col-sm-6">
				<div class="box">
					...
					<xsl:variable name="image" select="IMAGE1" />
					...
					<button onclick="addToCart({$productID}, '{$image}', '{$name}', {$price})" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to cart</button> 
					</p>
				</div>							
			</div>
